...
FEW_SHOT_EXAMPLES = [
  ...
  "top_cities": [
    ...
    },
    {
      ...
      "references": [
        {"title": "말레이시아 DE 노마드 비자 공식", "url": "https://www.digitalnomad.gov.my"},
        {"title": "Wikipedia — Kuala Lumpur", "url": "https://en.wikipedia.org/wiki/Kuala_Lumpur"}
      ]
    },
    {
      ...
      "references": [
        {"title": "베트남 전자비자 공식 포털", "url": "https://evisa.xuatnhapcanh.gov.vn"},
        {"title": "Wikipedia — Ho Chi Minh City", "url": "https://en.wikipedia.org/wiki/Ho_Chi_Minh_City"}
      ]
    }
  ],
  ...
  "top_cities": [
    {
      ...
      "references": [
        {"title": "포르투갈 비자 공식 포털", "url": "https://vistos.mne.gov.pt/en/national-visas/general-information/type-of-visa"},
        {"title": "Wikipedia — Lisbon", "url": "https://en.wikipedia.org/wiki/Lisbon"}
      ]
    },
    {
      "city": "Tallinn",
      ...
      "references": [
        {"title": "에스토니아 디지털 노마드 비자 공식", "url": "https://www.politsei.ee/en/instructions/digital-nomad-visa"},
        {"title": "Wikipedia — Tallinn", "url": "https://en.wikipedia.org/wiki/Tallinn"}
      ]
    },
    {
      "city": "Barcelona",
      ...
      "references": [
        {"title": "스페인 디지털 노마드 비자 공식", "url": "https://www.exteriores.gob.es/en/EmbajadasConsulados/pages/inicio.aspx"},
        {"title": "Wikipedia — Barcelona", "url": "https://en.wikipedia.org/wiki/Barcelona"}
      ]
    }
  ],
